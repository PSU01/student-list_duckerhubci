...
nohup pyton /student_age.py &

sleep 10s


#docker run -d --name student-list-api -p 5000:5000 dirane/student-list-jenkins:latest
#docker cp ${WORKSPACE}/simple_api/student_age.json student-list-api:/data/student_age.json
sleep 5s
